...
public class BeautipayForm extends javax.swing.JFrame {
    ...
    // Set the preferred width for the columns of jTable2
...
public BeautipayForm(String msg) {
    ...
    jLabel11.setText(msg); // Set the text of jLabel11 to the provided message
}

public void addtable(int id, String Name, int Qty, Double Price) {
    
    DefaultTableModel dt = (DefaultTableModel) jTable2.getModel(); // Get the table model of jTable2
    
    DecimalFormat df = new DecimalFormat("00.00"); // Create a decimal format with two decimal places
    double totPrice = Price * Double.valueOf(Qty); // Calculate the total price
    
    String TotalPrice = df.format(totPrice); // Format the total price
    
    // Check if the name already exists in the table and remove the row if it does
    ...
    // Create a new vector to hold the row data
    Vector v = new Vector();
    v.add(id); // Add id to the vector
    v.add(Name); // Add Name to the vector
    v.add(Qty); // Add Quantity to the vector
    v.add(TotalPrice); // Add Total Price to the vector
    
    dt.addRow(v); // Add the vector as a new row to the table model
}

public void cal() {
    // Calculate the total of all values in the table

    int numOfRow = jTable2.getRowCount(); // Get the number of rows in the table
    double tot = 0.0; // Initialize the total value to 0.0
    
    // Loop through each row to sum the values in the fourth column
    for (int i = 0; i < numOfRow; i++) {
        double value = Double.valueOf(jTable2.getValueAt(i, 3).toString());
        tot += value; // Add the value to the total
    }

    DecimalFormat df = new DecimalFormat("00.00"); // Create a decimal format with two decimal places
    total.setText(df.format(tot)); // Set the text of the total label to the formatted total
}
    ...
    private void initComponents() {
        ...
        b2.setFont(new java.awt.Font("Imprint MT Shadow", 0, 12)); // NOI18N
        b2.setText("Soft Makeup = 1500.00");
        ...
        b4.setFont(new java.awt.Font("Imprint MT Shadow", 0, 13)); // NOI18N
        b4.setText("Hair Color = 1000.00");
        ...
        b5.setFont(new java.awt.Font("Imprint MT Shadow", 0, 13)); // NOI18N
        b5.setText("Hair Care = 1500.00");
        ...
        b8.setFont(new java.awt.Font("Imprint MT Shadow", 0, 11)); // NOI18N
        b8.setText("Matte Makeup = 1000.00");
        ...
        b9.setFont(new java.awt.Font("Imprint MT Shadow", 0, 12)); // NOI18N
        b9.setText("Full Makeup = 2000.00");
        ...
        b10.setFont(new java.awt.Font("Imprint MT Shadow", 0, 11)); // NOI18N
        b10.setText("Dewy Makeup = 2500.00");
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(812, 13, 410, 370));
        ...
        bal.setText("00");
        getContentPane().add(bal, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 390, 149, -1));
        ...
        getContentPane().add(jOptionPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 280, 0, 10));

        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/purple bg.jpg"))); // NOI18N
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1230, 470));
    ...
    private void paybtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_paybtnActionPerformed
        ...
        if (paid < tot) {
        jOptionPane1.showMessageDialog(this, "Insufficient Payment.");
    } else {
    ...
    private void printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printActionPerformed
        ...
        try {
            ...
            b.setText(b.getText() + "----------------------------------------------------------------------------------------------\n");
            b.setText(b.getText() + "  ID \t Item \t\t Qty \t Price" + "\n");
            b.setText(b.getText() + "----------------------------------------------------------------------------------------------\n");
            ...
            b.setText(b.getText() + "  " + id + "\t"  +  Name + "\t\t" + "   " + Qty + "\t" + Price + "\n");

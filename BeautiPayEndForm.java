...
public class BeautiPayEndForm extends javax.swing.JFrame {

    
    public BeautiPayEndForm() {
        initComponents();
    }
    
     public BeautiPayEndForm(String msg) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Thank you for trusting");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BeautiPayEndForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

...
public class BeautipayStartForm extends javax.swing.JFrame {

    public BeautipayStartForm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("\"Getting your hair done is like");

        jLabel5.setFont(new java.awt.Font("Georgia", 0, 24)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(153, 0, 153));
        jLabel5.setText("a mini vacation.\"");
        ...
        jPanel1.getAccessibleContext().setAccessibleName("Greetings");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        new BeautipayForm(msg).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BeautipayStartForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
